...
export const Footer = props => {
  ...
  return (
    <>
      ...
      <footer
        className='wow fadeInUp relative z-10 bg-[#333333] pt-20 lg:pt-[100px]'
        data-wow-delay='.15s'>
        ...
        <div className='mt-12 border-t border-[#666666] border-opacity-40 py-8 lg:mt-[60px]'>
          <div className='container'>
            <div className='-mx-4 flex flex-wrap'>
        ...
        {/* Footer 背景 */}
        <div>
          <span className='absolute left-0 top-0 z-[-1] opacity-10 grayscale'>
            <img src='/images/starter/footer/shape-1.svg' alt='' />
          </span>

          <span className='absolute bottom-0 right-0 z-[-1] opacity-10 grayscale'>
            <img src='/images/starter/footer/shape-3.svg' alt='' />
          </span>

          <span className='absolute right-0 top-0 z-[-1] opacity-20 grayscale'>
            <SVGFooterCircleBG />
          </span>
        </div>
      </footer>
